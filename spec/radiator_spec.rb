...
describe "Radiator to JSON" do
  ...
  it "should return a json representation of a radiator" do
    ...
    pipeline1 = Pipeline.new 'pipeline1', '2', '2011-11-11T11:00:00'
    stage1 = Stage.new '1', "Success", ""
    stage2 = Stage.new '2', "Building", ""
    pipeline1.stages << stage1
    pipeline1.stages << stage2

    pipeline2 = Pipeline.new 'pipeline2', '2', '2011-11-11T11:00:00'
    ...
    radiator.to_json.should == "{\"pipelines\":[{\"name\":\"pipeline1\",\"build_label\":\"2\",\"last_build_date_time\":\"2011-11-11T11:00:00\",\"stages\":[{\"name\":\"1\",\"status\":\"Success\",\"last_build_date_time\":\"\"},{\"name\":\"2\",\"status\":\"Building\",\"last_build_date_time\":\"\"}],\"current_stage\":[]},{\"name\":\"pipeline2\",\"build_label\":\"2\",\"last_build_date_time\":\"2011-11-11T11:00:00\",\"stages\":[{\"name\":\"3\",\"status\":\"Success\",\"last_build_date_time\":\"\"},{\"name\":\"4\",\"status\":\"Failure\",\"last_build_date_time\":\"\"}],\"current_stage\":[]}]}"
  end
